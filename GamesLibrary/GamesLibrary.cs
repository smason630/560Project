...
namespace GamesLibrary
{
    ...
    public partial class GamesLibrary : Form
    {
        ...
        /*"SELECT g.Name AS 'Game Name', g.Rating, pg.PublishDate AS 'Publish Year', gen.Name AS 'Genre', c.Name AS 'Console', p.Name AS 'Publisher Name', d.Name AS 'Developer Name' " +
